...
class TestRectangle(unittest.TestCase):
	...
	def test_rectangle_update_args(self):
		print(self.r_update)
		self.assertEqual(self.capture_stdout(self.r_update, "print"), "[Rectangle] (4) 10/10 - 10/10\n")
	...
	def test_rectangle_update_kwargs(self):
		print(self.r_update)
		self.assertEqual(self.capture_stdout(self.r_upd_kwargs, "print"), "[Rectangle] (5) 5/5 - 5/5\n")
